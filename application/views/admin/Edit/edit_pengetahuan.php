...
<div class="form-group">
    ...
    <select id="namaPenyakit" name="id_penyakit" class="form-control " style="width: 100%;" required>
...
<div class="form-group">
    ...
    <select id="namaGejala" name="id_gejala" class="form-control " style="width: 100%;" required>
...
<div class="form-group">
    <label for="cf">CF PAKAR</label>
    <input value="<?= $pengetahuan['cf'] ?>" id="cf" type="number" step="0.1" class="form-control" name="cf" placeholder="bobot dalam decimal (contoh: 1.0, 0.4, dst)" required>
</div>